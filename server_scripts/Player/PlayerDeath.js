//-- TaCZ: Zombies
// Location: Server
// Purpose: Handlers players death wirh visuals and / player points
// Configurable: Yes
...
EntityEvents.death(event => {
    ...
    if (entity.isPlayer()) {
        ...
        entity.server.runCommandSilent(
            `playsound minecraft:entity.ender_dragon.ambient master @a ${entity.x} ${entity.y} ${entity.z} 10.0 1.0`
        )
    }
})
// Punishing player
EntityEvents.death(event => {
    ...
    if (entity.isPlayer()) {
        ...
        let new_points = Math.floor(current_points / Settings.Player.DividePointsAmount)
        ...
        entity.persistentData.putInt('KillCombo', 0)
    }
})
...
PlayerEvents.respawned(event => {
    if (Settings.Player.SpectatorOnDeath) {
